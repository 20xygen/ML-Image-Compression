...
The main research and experiments are presented in `ImageCompression.ipynb`.  
The final model architecture is separated into `Tenet.ipynb` for clarity and reuse.
